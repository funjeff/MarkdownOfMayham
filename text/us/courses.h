...
COURSE_ACTS(COURSE_WF, _("   THE REALLY FAR AWAY FROM THE SPAGHETTI SHOP DESERT"),
       _("... UNFORTUNATE NAME HUH?")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
...
COURSE_ACTS(COURSE_SSL, _("    EL LEDGEO DE LUIS"),
       _("CLUE 6: THERES A SECRET 6TH CLUE SOMEWHERE") , _("SHINING ATOP THE PYRAMID")      , _("INSIDE THE ANCIENT PYRAMID"),
...
COURSE_ACTS(COURSE_WDW, _("   SPAGHETTI SHOP"),
       _("YUMMMMMMMMMMMMMMMMMMMMMMMMMMMY")         , _("TOP O' THE TOWN")               , _("SECRETS IN THE SHALLOWS & SKY"),
       _("EXPRESS ELEVATOR--HURRY UP!")   , _("GO TO TOWN FOR RED COINS")      , _("QUICK RACE THROUGH DOWNTOWN!"))

COURSE_ACTS(COURSE_TTM, _("     SLUGGA SLUGGA CHOO CHOO"),
       _("after me treasure")            , _("MYSTERY OF THE MONKEY CAGE")    , _("SCARY 'SHROOMS, RED COINS"),
...
COURSE_ACTS(COURSE_TTC, _("        SUPER ABANDONED SANDY TRAIN TUNNELS OF DOOOOM"),
       _("its unlikely a train couldve gone through here")            , _("THE PIT AND THE PENDULUMS")     , _("GET A HAND"),
