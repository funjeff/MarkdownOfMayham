...
const BehaviorScript *sWarpBhvSpawnTable[] = {
    ...
    bhvRestartCheckpoint, bhvWarpOneWay, bhvAssHurtWarp, bhvWarpIceCream,
};
...
u8 sSpawnTypeFromWarpBhv[] = {
    ...
    MARIO_SPAWN_INSTANT_ACTIVE, MARIO_SPAWN_INSTANT_ACTIVE, MARIO_SPAWN_SPIN_AIRBORNE_AND_HURT_ASS, MARIO_SPAWN_PIPE,
};
