...
enum MarioSpawnType {
    ...
    MARIO_SPAWN_SPIN_AIRBORNE_AND_HURT_ASS,
    MARIO_SPAWN_AND_RENDER,
    MARIO_SPAWN_FLYING,
...
enum HUDDisplayFlag {
    ...
    HUD_DISPLAY_DEFAULT = (HUD_DISPLAY_FLAG_TIMER | HUD_DISPLAY_LIVE_REACTION | HUD_DISPLAY_FLAG_CAMERA_AND_POWER |  HUD_DISPLAY_FLAG_UNKNOWN_0020)
};
