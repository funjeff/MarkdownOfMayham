...
const LevelScript level_ssl_entry[] = {
	...
	AREA(1, ssl_area_1),
		...
		OBJECT(MODEL_NONE, -7211, 2204, 3797, 0, -95, 0, (03 << 16), bhvRestartCheckpoint),
		...
		OBJECT(MODEL_SDOOR, -8364, 2205, 3853, 89, 91, 0, (31 << 24), bhvStarDoor),
		OBJECT(MODEL_SDOORR, -8364, 2205, 3698, 89, -93, 0, (31 << 24), bhvStarDoor),
		...
		OBJECT(MODEL_STAR, -13339, 2965, -3344, 0, -90, 0, 0x00000000, bhvRealStar),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 6341, 2090, 16475, -14, -91, 11, (46 << 16), bhvMessagePanel),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 8502, 1252, 13431, 1, 92, 5, (49 << 16), bhvMessagePanel),
		...
		OBJECT(MODEL_BOBOMB_BUDDY, 1647, 119, 13561, 2, 0, -1, (50 << 16), bhvBobombBuddy),
		OBJECT(MODEL_NONE, 451, 301, 17065, 0, -90, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, -180, 451, 301, 17065),
