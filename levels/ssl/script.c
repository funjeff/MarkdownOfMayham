...
const LevelScript level_ssl_entry[] = {
	...
	AREA(1, ssl_area_1),
		...
		OBJECT(MODEL_NONE, -8116, 2204, 1200, 0, 0, 0, 0x00000000, bhvRestartCheckpoint),
		...
		OBJECT(MODEL_SDOOR, -8364, 2205, 3853, 90, 90, 0, 0x00000000, bhvStarDoor),
		OBJECT(MODEL_SDOORR, -8364, 2205, 3698, 90, -90, 0, 0x00000000, bhvStarDoor),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 6341, 2090, 16475, 0, -90, 0, (62 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, -1576, 115, 23153, -3, -178, 0, (62 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, -3673, 2245, 17226, -6, -94, 2, (62 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, 8502, 1252, 13431, 0, 90, 0, (62 << 16), bhvMessagePanel),
		...
		OBJECT(MODEL_BOBOMB_BUDDY, 1463, 119, 12880, 0, 0, 0, (41 << 16), bhvBobombBuddy),
		OBJECT(MODEL_WOODEN_SIGNPOST, -3951, 102, 13492, 0, 90, 0, (41 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, -4314, 1028, 13470, 0, 90, 0, (41 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, -527, -797, 3070, 0, 0, 0, (41 << 16), bhvMessagePanel),
		OBJECT(MODEL_NONE, -7704, 2264, 2308, 0, -159, 0, (41 << 16), bhvSignOnWall),
		OBJECT(MODEL_WOODEN_SIGNPOST, -14, 102, 13255, 0, 0, 0, (41 << 16), bhvMessagePanel),
