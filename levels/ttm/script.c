...
const LevelScript level_ttm_entry[] = {
	...
	AREA(1, ttm_area_1),
		...
		OBJECT(MODEL_TRAIN, -14268, 115, 31774, 0, -90, 0, 0x00010000, bhvTrain),
		OBJECT(MODEL_NONE, -3335, 115, -26200, 0, -90, 0, 0x0B010000, bhvWarp),
		OBJECT(MODEL_NONE, -3810, 196, 30025, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -3810, 196, 30025),
