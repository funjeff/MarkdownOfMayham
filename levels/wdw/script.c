...
const LevelScript level_wdw_entry[] = {
	...
	AREA(1, wdw_area_1),
		...
		OBJECT(MODEL_NONE, -2107, 2663, -1382, 0, -90, 0, (0 << 24), bhvCoinFormation),
		OBJECT(MODEL_YELLOW_COIN, 4745, 2129, -6056, 0, 90, 0, (0 << 24), bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 4867, 2129, -5761, 0, 90, 0, (0 << 24), bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 4702, 2129, -5415, 0, 90, 0, (0 << 24), bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 4394, 2129, -5294, 0, 90, 0, (0 << 24), bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 4123, 2129, -5444, 0, 90, 0, (0 << 24), bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 4044, 2129, -5729, 0, 90, 0, (0 << 24), bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 4110, 2129, -6003, 0, 90, 0, (0 << 24), bhvOneCoin),
		...
		OBJECT(MODEL_YELLOW_COIN, 4417, 2129, -6167, 0, 90, 0, (0 << 24), bhvOneCoin),
		...
		OBJECT(MODEL_NONE, -2864, 2276, -21066, 0, -180, 0, 0x000A0000, bhvSpinAirborneWarp),
