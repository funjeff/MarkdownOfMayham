...
const GeoLayout bob_area_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 593, 5016, -5027, bob_dl_Cube_006_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, -59, 723, -3990, bob_dl_DeathPlane_001_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
